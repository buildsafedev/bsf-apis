...
type OAuthAuthenticateResponse struct {
	...
	UserId string `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // The ID of the authenticated or created user
}
...
func (x *OAuthAuthenticateResponse) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
var file_buildsafe_v1_auth_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x4e, 0x0a, 0x18, 0x4f, 0x41, 0x75, 0x74, 0x68, 0x41, 0x75, 0x74, 0x68, 0x65,
	...
	0x32, 0x16, 0x2e, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x73, 0x61, 0x66, 0x65, 0x2e, 0x76, 0x31, 0x2e,
	0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64,
	0x65, 0x72, 0x22, 0x34, 0x0a, 0x19, 0x4f, 0x41, 0x75, 0x74, 0x68, 0x41, 0x75, 0x74, 0x68, 0x65,
	0x6e, 0x74, 0x69, 0x63, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x2a, 0x39, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x76,
	...
	,
...
var file_buildsafe_v1_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_buildsafe_v1_auth_proto_goTypes = []interface{}{
...
var file_buildsafe_v1_auth_proto_depIdxs = []int32{
	...
	2, // 2: buildsafe.v1.AuthService.OAuthAuthenticate:output_type -> buildsafe.v1.OAuthAuthenticateResponse
...
func file_buildsafe_v1_auth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_buildsafe_v1_auth_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OAuthAuthenticateRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_buildsafe_v1_auth_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OAuthAuthenticateResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
